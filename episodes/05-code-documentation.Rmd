...
> Kopec-Harding et al, (`r format(Sys.Date(), "%Y")`). _Compendium of R code and data for an analyis of NASA extravehicular data. Accessed `r format(Sys.Date(), "%d %b %Y")`. Online at <https://doi.org/xxx/xxx>
```
